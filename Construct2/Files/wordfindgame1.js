  ...
  var WordFindGame1 = function() {
    ...
    */
    var calcOrientation = function (x1, y1, x2, y2) {
      ...
      for (var orientation in wordfind1.orientations) {
        var nextFn = wordfind1.orientations[orientation];
    ...
    return {
      ...
      */
      create: function(number, puzzleEl, wordsEl, options) {
        ...
        var puzzle = wordfind1.newPuzzle(number, options);
      ...
      */
      solve: function(/*puzzle, words*/) {
        ...
        /*var solution = wordfind1.solve(puzzle, words).found;
        ...
        for( var i = 0, len = solution.length; i < len; i++) {
          var word = solution[i].word,
              ...
              x = solution[i].x,
              y = solution[i].y,
              next = wordfind1.orientations[orientation];
...
//      console.log(this.terminou);
  ...
  */
  window.wordfindgame1 = WordFindGame1();

}(document, jQuery, wordfind1));
